...
<section class="content">
  <form method="POST" action="/spp_profil_syarikat/{{ $spp_profil_syarikat -> id}}">
    @method('PUT')  
        <div>
          <div class="row">
            <div class="col card">
              <div class="form-group">
                ...
                <div>
                  ...
                  <select name="idKategoriSyarikat" id="kod_negeri_syarikat">
                    @foreach ($spp_profil_syarikat1 as $sps)
                      <option value="{{ $sps -> id }}">{{ $sps -> nama }}</option>
                    @endforeach
                    </select>
                    <br>
                  <label style=" padding-right: 20px" for="nama">Nama Syarikat :</label>
                  <input class="form-control" value="{{ $spp_profil_syarikat -> nama }}"  type="text" id="nama" name="nama" >
                  <label style=" padding-right: 20px" for="alamat1">Alamat</label>
                  <input class="form-control" placeholder="alamat" value="{{ $spp_profil_syarikat -> alamat1 }}" type="text" id="alamat1" name="alamat1" > <br>
                  <input class="form-control" placeholder="alamat" value="{{ $spp_profil_syarikat -> alamat }}" type="text" id="alamat" name="alamat" > <br>
                  <label style=" padding-right: 20px" for="poskod"></label>Poskod :<br>
                  <input class="form-control" value="{{ $spp_profil_syarikat -> poskod }}"  type="number" id="poskod" name="poskod" >
    
                  <label for="idKategoriSyarikat">Negeri:</label>
                  <select name="idKategoriSyarikat" id="kod_negeri_syarikat">
                    @foreach ($spp_profil_syarikat2 as $neg)
                      <option {{ $spp_profil_syarikat-> idNegeri ==  $neg-> id ? 'selected':''  }} value="">{{ $neg -> nama }}</option>
                    @endforeach
                    </select>
                    <br>
                  ...
                  <input class="form-control" value="{{ $spp_profil_syarikat -> noTel }}" placeholder=""  type="text" id="noTel" name="noTel" > <br>
                  <label style=" padding-right: 20px" for="noFax">No Fax :</label>
                  <input class="form-control" value="{{ $spp_profil_syarikat -> noFax }}" placeholder=""  type="text" id="noFax" name="noFax" > <br>
                  <label style=" padding-right: 20px" for="email">Emel Syarikat :</label>
                  <input class="form-control" value="{{ $spp_profil_syarikat -> email }}" placeholder="Emel"  type="email" id="email" name="email" > <br>
                </div>
