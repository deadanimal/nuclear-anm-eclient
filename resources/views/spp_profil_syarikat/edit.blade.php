...
<section class="content">
  <form method="POST" action="/spp_profil_syarikat/{{ $spp_profil_harga_servis -> id}}">
    @method('PUT')  
        <div>
          <div class="row">
            <div class="col card">
              <div class="form-group">
                ...
                <div>
                  ...
                  <input class="form-control" value="{{ $kod -> nama }}"  type="text" id="nama" name="nama" >
                  <label style=" padding-right: 20px" for="alamat1">Alamat</label>
                  <input class="form-control" placeholder="alamat" value="{{ $kod -> alamat1 }}" type="text" id="alamat1" name="alamat1" > <br>
                  <input class="form-control" placeholder="alamat" value="{{ $kod -> alamat }}" type="text" id="alamat" name="alamat" > <br>
                  <label style=" padding-right: 20px" for="poskod"></label>Poskod :<br>
                  <input class="form-control" value="{{ $kod -> poskod }}"  type="number" id="poskod" name="poskod" >
                  ...
                  <input class="form-control" value="{{ $kod -> noTel }}" placeholder=""  type="text" id="noTel" name="noTel" > <br>
                  <label style=" padding-right: 20px" for="noFax">No Fax :</label>
                  <input class="form-control" value="{{ $kod -> noFax }}" placeholder=""  type="text" id="noFax" name="noFax" > <br>
                  <label style=" padding-right: 20px" for="email">Emel Syarikat :</label>
                  <input class="form-control" value="{{ $kod -> email }}" placeholder="Emel"  type="email" id="email" name="email" > <br>
                </div>
